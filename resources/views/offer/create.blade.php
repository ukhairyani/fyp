            ...
            <div class="col-md-10">
                <form class="form-horizontal" action="{{ action('OfferController@store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{ $errors->has('pickup_loc') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="pickup_loc" type="text" class="form-control" name="pickup_loc" value="{{ old('pickup_loc') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('info') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <textarea id="info" rows="4" cols="5" type="text" class="form-control" name="info" value="{{ old('info') }}" required autofocus></textarea>
